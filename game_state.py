...
class GameState():
    ...
    def calculate_fitness(self):
        if self.__heuristic_func == "manhattan": # Calcula a mhd para todos os blocos
    ...
    def calculate_manhattan(self, x1, y1, x2, y2): 
        return abs(x1 - x2) + abs(y1 - y2) #mhd calculada através do módulo da diferença entre as cordenadas x e y